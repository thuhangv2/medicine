    ...
    public function addToCart(Request $request)
    {
        ...
        if ($instance == 'default') {
            ...
            foreach ($cart as $key => $item) {
                ...
                $htmlCart .= '<li class="item odd"> <a href="' . url('san-pham/' . ktc_str_convert($item->name) . '_' . $item->id . '.html') . '" title="' . $item->name . '" class="product-image"><img src="' . asset('share/' . $product->image) . '" alt="' . $item->name . '" width="65"></a>
