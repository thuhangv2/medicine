<?php
#app/Http/Admin/Controllers/Modules/Api/ShopApi.php
namespace App\Admin\Controllers\Modules\Api;

use App\Http\Controllers\Controller;
use App\Models\ShopApi as ShopApiModel;
...
class ShopApi extends Controller
{
    ...
    protected function grid()
    {
        ...
        $grid = new Grid(new ShopApiModel);
        $grid->id('ID')->sortable();
    ...
    {
        $form = new Form(new ShopApiModel);
    ...
    {
        $show = new Show(ShopApiModel::findOrFail($id));
        return $show;
    }
