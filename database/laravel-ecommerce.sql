...
-- Dumping structure for table giaiphap247.admin_menu
...
-- Dumping data for table giaiphap247.admin_menu: ~35 rows (approximately)
...
-- Dumping structure for table giaiphap247.admin_operation_log
...
-- Dumping data for table giaiphap247.admin_operation_log: ~0 rows (approximately)
DELETE FROM `admin_operation_log`;
/*!40000 ALTER TABLE `admin_operation_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `admin_operation_log` ENABLE KEYS */;

-- Dumping structure for table giaiphap247.admin_permissions
...
-- Dumping data for table giaiphap247.admin_permissions: ~9 rows (approximately)
...
-- Dumping structure for table giaiphap247.admin_roles
...
-- Dumping data for table giaiphap247.admin_roles: ~4 rows (approximately)
...
-- Dumping structure for table giaiphap247.admin_role_menu
...
-- Dumping data for table giaiphap247.admin_role_menu: ~6 rows (approximately)
...
-- Dumping structure for table giaiphap247.admin_role_permissions
...
-- Dumping data for table giaiphap247.admin_role_permissions: ~12 rows (approximately)
...
-- Dumping structure for table giaiphap247.admin_role_users
...
-- Dumping data for table giaiphap247.admin_role_users: ~2 rows (approximately)
...
-- Dumping structure for table giaiphap247.admin_users
...
-- Dumping data for table giaiphap247.admin_users: ~2 rows (approximately)
...
-- Dumping structure for table giaiphap247.admin_user_permissions
...
-- Dumping data for table giaiphap247.admin_user_permissions: ~0 rows (approximately)
DELETE FROM `admin_user_permissions`;
/*!40000 ALTER TABLE `admin_user_permissions` DISABLE KEYS */;
/*!40000 ALTER TABLE `admin_user_permissions` ENABLE KEYS */;

-- Dumping structure for table giaiphap247.banner
...
-- Dumping data for table giaiphap247.cms_category: ~3 rows (approximately)
...
-- Dumping structure for table giaiphap247.cms_conten
...
-- Dumping data for table giaiphap247.cms_conten: ~1 rows (approximately)
...
-- Dumping structure for table giaiphap247.cms_image
...
-- Dumping data for table giaiphap247.cms_image: ~2 rows (approximately)
...
-- Dumping structure for table giaiphap247.cms_news
...
-- Dumping data for table giaiphap247.cms_news: ~7 rows (approximately)
...
-- Dumping data for table giaiphap247.cms_page: ~4 rows (approximately)
...
INSERT INTO `cms_page` (`id`, `title`, `image`, `keyword`, `description`, `content`, `uniquekey`, `status`) VALUES
	...
	(2, 'Giới thiệu', '', 'Giới thiệu website, hướng dẫn đặt hàng', 'Giới thiệu website', '<p><span style="font-size:26px;"><strong><span style="color:#f39c12;">AloChip</span></strong></span><span style="font-size:16px;"> </span><span style="font-size:20px;">h&acirc;n hạnh phục vụ qu&yacute; kh&aacute;ch sản phẩm v&agrave; dịch vụ tốt nhất trong lĩnh vực <strong><span style="color:#2ecc71;">qu&agrave; tặng c&ocirc;ng nghệ</span></strong>, <strong><span style="color:#f39c12;">linh kiện điện tử</span></strong>, <strong><span style="color:#2980b9;">c&ocirc;ng nghệ in 3D</span></strong>.<br />\r\nĐừng ngần ngại, h&atilde;y li&ecirc;n hệ với ch&uacute;ng t&ocirc;i:</span><span style="font-size:16px;"></span></p>\r\n\r\n<p><span style="font-size:20px;"><img alt="" src="/share/files/GreenPhone.png" style="border-width: 0px; border-style: solid; margin: 0px; width: 30px; height: 30px;" /><strong>&nbsp;Số điện thoại:&nbsp;</strong></span><span style="font-size:26px;"><strong><span style="color:#e74c3c;">0168.498.9009</span></strong></span></p>\r\n\r\n<p><span style="font-size:26px;"><strong><span style="color:#e74c3c;"></span></strong></span><span style="font-size:20px;"><strong><span style="color:#e74c3c;"></span><br />\r\n<span style="color:null;"></span></strong></span></p>\r\n\r\n<p style="text-align: center;"><span style="font-size:28px;"><img alt="heart" height="23" src="https://alochip.com/packages/ckeditor/plugins/smiley/images/heart.png" title="heart" width="23" /><img alt="heart" height="23" src="https://alochip.com/packages/ckeditor/plugins/smiley/images/heart.png" title="heart" width="23" /><img alt="heart" height="23" src="https://alochip.com/packages/ckeditor/plugins/smiley/images/heart.png" title="heart" width="23" /><img alt="heart" height="23" src="https://alochip.com/packages/ckeditor/plugins/smiley/images/heart.png" title="heart" width="23" />&nbsp;&nbsp;<strong><span style="color:#27ae60;">HƯỚNG DẪN ĐĂNG K&Yacute; T&Agrave;I KHOẢN V&Agrave; ĐẶT H&Agrave;NG ONLINE</span><span style="color:#27ae60;">&nbsp;</span></strong><img alt="heart" height="23" src="https://alochip.com/packages/ckeditor/plugins/smiley/images/heart.png" title="heart" width="23" /><img alt="heart" height="23" src="https://alochip.com/packages/ckeditor/plugins/smiley/images/heart.png" title="heart" width="23" /><img alt="heart" height="23" src="https://alochip.com/packages/ckeditor/plugins/smiley/images/heart.png" title="heart" width="23" /><img alt="heart" height="23" src="https://alochip.com/packages/ckeditor/plugins/smiley/images/heart.png" title="heart" width="23" /></span></p>\r\n\r\n<p><strong><span style="font-size:24px;">1. Đăng k&yacute; t&agrave;i khoản v&agrave; đăng nhập:</span></strong></p>\r\n\r\n<p><strong><img alt="" src="/share/files/2018-08-11_213412.png" style="width: 1000px; height: 471px;" /></strong></p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><strong><span style="font-size:24px;">2. Đặt H&agrave;ng Online:</span></strong><br />\r\n&nbsp;<img alt="" src="/share/files/huong-dan-dat-hang-1.jpg" style="width: 700px; height: 200px;" /></p>\r\n\r\n<p><img alt="" src="/share/files/huong-dan-mua-hang.png" style="width: 1024px; height: 266px;" /></p>\r\n\r\n<p><img alt="" src="/share/files/2018-08-11_220705.png" style="width: 1000px; height: 496px;" /></p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><img alt="" src="/share/files/2018-08-11_220744.png" style="width: 1000px; height: 496px;" /></p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><img alt="" src="/share/files/2018-08-11_220835.png" style="width: 1000px; height: 496px;" /></p>', 'gioi-thieu', 1),
	(3, 'Nội dung thông báo cho người dùng', NULL, 'thông báo', NULL, '<h2>Shop and Save 10%</h2>\r\n\r\n<p><button class="btn btn-default" type="button">Shop now</button></p>', 'notice', 1),
	(4, 'Liên hệ', NULL, 'liên hệ', NULL, '<p><strong>Vui l&ograve;ng li&ecirc;n hệ với ch&uacute;ng t&ocirc;i</strong></p>', 'lien-he', 1);
/*!40000 ALTER TABLE `cms_page` ENABLE KEYS */;

-- Dumping structure for table giaiphap247.config
...
-- Dumping data for table giaiphap247.config: ~24 rows (approximately)
DELETE FROM `config`;
...
-- Dumping structure for table giaiphap247.failed_jobs
...
-- Dumping data for table giaiphap247.failed_jobs: ~0 rows (approximately)
DELETE FROM `failed_jobs`;
/*!40000 ALTER TABLE `failed_jobs` DISABLE KEYS */;
/*!40000 ALTER TABLE `failed_jobs` ENABLE KEYS */;

-- Dumping structure for table giaiphap247.jobs
...
-- Dumping data for table giaiphap247.jobs: ~1 rows (approximately)
DELETE FROM `jobs`;
...
-- Dumping structure for table giaiphap247.migrations
...
-- Dumping data for table giaiphap247.migrations: ~6 rows (approximately)
...
-- Dumping structure for table giaiphap247.password_resets
...
-- Dumping data for table giaiphap247.password_resets: ~2 rows (approximately)
...
-- Dumping structure for table giaiphap247.promocodes
...
-- Dumping data for table giaiphap247.promocodes: ~11 rows (approximately)
...
-- Dumping structure for table giaiphap247.promocode_user
...
-- Dumping data for table giaiphap247.promocode_user: ~10 rows (approximately)
...
-- Dumping structure for table giaiphap247.shop_attribute
...
-- Dumping data for table giaiphap247.shop_attribute: ~2 rows (approximately)
...
-- Dumping structure for table giaiphap247.shop_brand
...
-- Dumping data for table giaiphap247.shop_brand: ~6 rows (approximately)
...
-- Dumping structure for table giaiphap247.shop_category
...
-- Dumping data for table giaiphap247.shop_category: ~19 rows (approximately)
...
-- Dumping structure for table giaiphap247.shop_image
...
-- Dumping data for table giaiphap247.shop_image: ~82 rows (approximately)
...
INSERT INTO `shop_image` (`id`, `image`, `product_id`, `sort`, `status`) VALUES
	(8, 'images/dea5dde23d9e8952112c10711a3d3db4.jpg', 1, 0, 0),
	(9, 'images/833097a0c97188dcd40519e83cd793bd.gif', 1, 0, 0),
	(10, 'images/e6a3bee3a1f5550b9e0d65b00c8b2363.jpg', 2, 0, 0),
	(12, 'product_slide/b6c87ba8e676461e4502a618ceedca89.jpg', 3, 0, 0),
	(13, 'product_slide/1305708f195418b5351ae869e3e8d8ca.jpg', 3, 0, 0),
	(17, 'product_slide/60dcec513d4c9acb6d653ce8966930ed.jpg', 10, 0, 0),
	(18, 'product_slide/833d0064c62471a1746ea42aa3786456.jpg', 11, 0, 0),
	(19, 'product_slide/011fc59761a1d35adc0f5a0ccf9d0b53.jpg', 11, 0, 0),
	(21, 'product_slide/0f73dc4446785beaf09572167ef8336b.png', 10, 0, 0),
	(22, 'product_slide/a6620c12ba92c66d34014f5680c53519.jpg', 8, 0, 0),
	(23, 'product_slide/1612fabf9fa06363a5ff7bef45786802.jpg', 8, 0, 0),
	(29, 'product_slide/d4926deee346d97a86899ac4ffe8ffd8.jpg', 21, 0, 0),
	(30, 'product_slide/ea4729c1e8d8c73e21b30b96ea304093.jpg', 21, 0, 0),
	(31, 'product_slide/3a150b079a26e643d6e50e1f77751106.jpg', 4, 0, 0),
	(32, 'product_slide/b0a8dfb341798df115632b00ab5f61fc.jpg', 4, 0, 0),
	(33, 'product_slide/3cc92d0c780ee4f40a81f2440e2cf852.jpg', 22, 0, 0),
	(34, 'product_slide/753e0ae6a40844a79c80fae0648f8db5.jpg', 22, 0, 0),
	(35, 'product_slide/1dc4d1e2b188a486d28fb9688c78517d.jpg', 5, 0, 0),
	(36, 'product_slide/292cdacbfd2caf5c4148628ff67afb9c.jpg', 5, 0, 0),
	(37, 'product_slide/eb5282e1e95083646d5b6cdfbc410248.jpg', 6, 0, 0),
	(38, 'product_slide/c8db935e6ebb89389d0cb06b9a17173a.jpg', 7, 0, 0),
	(39, 'product_slide/d09671a5639f0af4d0b33c7dd85d734c.jpg', 20, 0, 0),
	(41, 'product_slide/688f940d3e5c08c0a425dfd42b02b383.jpg', 5, 0, 0),
	(42, 'product_slide/c3863b9aedef092fbe103d11e63a295a.jpg', 5, 0, 0),
	(43, 'product_slide/be517a512e8c1657a3a8a67514ed83fe.jpg', 4, 0, 0),
	(44, 'product_slide/db4e41788522f4500c6db0487830173f.jpg', 4, 0, 0),
	(46, 'product_slide/d7d93959a27f114820500da5c9f95f9c.jpg', 3, 0, 0),
	(47, 'product_slide/6985a34d3323269818f62459308f6a87.jpg', 3, 0, 0),
	(48, 'product_slide/128cd18c10f0cd54e81fb245c350ff12.jpg', 3, 0, 0),
	(49, 'product_slide/b2582b8c2cb75c81df418398fac4ed7e.jpg', 6, 0, 0),
	(50, 'product_slide/3789f2bc17549642e49ca1ee1527013c.jpg', 6, 0, 0),
	(51, 'product_slide/de4be6fb922ef6e571989bd88018bfe2.jpg', 6, 0, 0),
	(53, 'product_slide/75c659a9dc09d2fd41fd0d8052d885d4.jpg', 9, 0, 0),
	(54, 'product_slide/cb83f6679cffed3f18e65e87b341f1f9.jpg', 9, 0, 0),
	(55, 'product_slide/1273cfe1cd4113c83c70c82a4df25719.jpg', 9, 0, 0),
	(56, 'product_slide/f3a84efe70e935f64e9e45648fc6d5a0.jpg', 9, 0, 0),
	(57, 'product_slide/d273cc3089969e743ee47625c7bba16b.jpg', 12, 0, 0),
	(58, 'product_slide/9e7544825d9d65ac911b1f8cc227aa85.jpg', 12, 0, 0),
	(59, 'product_slide/435b2a2f2b008726ada184ed3ecb72e0.jpg', 12, 0, 0),
	(60, 'product_slide/3c67d431bbed64ef7d575a71ad746fb2.jpg', 7, 0, 0),
	(61, 'product_slide/f7651c095b3d057e0cdb372e91abb1b4.jpg', 20, 0, 0),
	(62, 'product_slide/293e94230c6523a2652d275423a997a8.jpg', 5, 0, 0),
	(63, 'product_slide/12b661cc8ff5f79aa9c8b6f7e27bf855.jpg', 5, 0, 0),
	(64, 'product_slide/3ed5716f7374eb413e61921e0a011548.jpg', 5, 0, 0),
	(65, 'product_slide/45bda14619185d6a258170bc59d3ce7e.jpg', 22, 0, 0),
	(66, 'product_slide/1c5914e540d6de4e302d76ff729aa5ed.jpg', 22, 0, 0),
	(67, 'product_slide/fd2dd8e0a5574f2de11ea4f2edbe41d2.jpg', 12, 0, 0),
	(68, 'product_slide/b60e61f2f271a2c9b9facf876ff073b0.jpg', 21, 0, 0),
	(75, 'product_slide/6f45b1116da292758b6246e61ead7625.jpg', 28, 0, 0),
	(76, 'product_slide/0a5b2454643a95012bfb8673da301fe2.jpg', 28, 0, 0),
	(77, 'product_slide/4324abb20b869e3d6686becfc9ad8683.jpg', 34, 0, 0),
	(78, 'product_slide/ffc6c2b7e1027db114e9c35dd0fd7f31.jpg', 34, 0, 0),
	(79, 'product_slide/145129c39c240cff03fbc5fd5ff1769d.jpg', 36, 0, 0),
	(80, 'product_slide/6a0addde0ce6d13c278fb75eadb3499e.jpg', 37, 0, 0),
	(81, 'product_slide/4d40bf0bce6e78582f90205df0e72000.jpg', 37, 0, 0),
	(82, 'product_slide/5b6c03fc5f233f5b826548509228636e.jpg', 38, 0, 0),
	(83, 'product_slide/eba5db6fbdc2efbe987d6a85133fefc7.jpg', 38, 0, 0),
	(84, 'product_slide/b85c4744e07d2b41af66a78c8597a33d.jpg', 39, 0, 0),
	(85, 'product_slide/b259b482e0b7c0109ac8f102d0cf924e.jpg', 39, 0, 0),
	(86, 'product_slide/17d8771beafd9ad028185fc8cdf171d7.jpg', 39, 0, 0),
	(87, 'product_slide/072cf95c1a946f147f76f965134916cf.jpg', 40, 0, 0),
	(88, 'product_slide/95c713d3b36b06db886638a9ef284bf6.jpg', 40, 0, 0),
	(89, 'product_slide/88a6ac690bb75a9f3b9b21accd11171f.jpg', 42, 0, 0),
	(90, 'product_slide/89dcf0721f7466bc717f04421e0bebc8.jpg', 42, 0, 0),
	...
	(95, NULL, 44, 0, 0),
	(96, 'product_slide/147b64e5fb1f33d8ceeba2102428848f.jpg', 45, 0, 0),
	(97, 'product_slide/1b3bf3b4ec24c18965bc92d827c2f828.jpg', 46, 0, 0),
	(98, 'product_slide/9a1c877ebcd419099ae9d33c498f07b2.jpg', 46, 0, 0),
	(99, 'product_slide/36086ea1eeec830f294ed50de3a148be.jpg', 46, 0, 0),
	(100, 'product_slide/986587f9fa03971e9e4a4095c5b6a318.jpg', 47, 0, 0),
	(102, 'product_slide/e4d319bb1eab1d8e38022fe6e5ba1b61.jpg', 48, 0, 0),
	(103, 'product_slide/96d350b8e250696db381ce96f863ab09.jpg', 48, 0, 0),
	(106, 'product_slide/9c742ed9d093017fb7be690e285036a0.jpg', 29, 0, 0),
	(107, 'product_slide/76825ad86e36e78b0b5afabfb0feb1aa.jpg', 30, 0, 0),
	(108, 'product_slide/20d6fc65ed301d7cb86ee3588ab8e20e.jpg', 27, 0, 0),
	(109, 'product_slide/8f2ece08215f55b53198c2d7a39d38cb.png', 49, 0, 0),
...
-- Dumping structure for table giaiphap247.shop_option
...
-- Dumping data for table giaiphap247.shop_option: ~3 rows (approximately)
...
-- Dumping structure for table giaiphap247.shop_option_detail
...
-- Dumping data for table giaiphap247.shop_option_detail: ~37 rows (approximately)
...
INSERT INTO `shop_option_detail` (`id`, `name`, `add_price`, `option_id`, `product_id`) VALUES
	...
	(609, 'XL', 0, 2, 12),
	(610, 'XXL', 0, 2, 12),
	(616, 'Màu Trắng Đục', 0, 1, 34),
	(617, 'Trong Suốt', 0, 1, 34),
	(618, 'ID=2 mm, OD=4 mm', 0, 2, 34),
	(619, 'ID=2 mm, OD=3 mm', 0, 2, 34),
	(620, 'ID=3 mm, OD=4 mm', 0, 2, 34);
/*!40000 ALTER TABLE `shop_option_detail` ENABLE KEYS */;

-- Dumping structure for table giaiphap247.shop_order
...
-- Dumping data for table giaiphap247.shop_order: ~4 rows (approximately)
...
-- Dumping structure for table giaiphap247.shop_order_detail
...
-- Dumping data for table giaiphap247.shop_order_detail: ~1 rows (approximately)
...
-- Dumping structure for table giaiphap247.shop_order_history
...
-- Dumping data for table giaiphap247.shop_order_history: ~5 rows (approximately)
...
-- Dumping structure for table giaiphap247.shop_order_status
...
-- Dumping data for table giaiphap247.shop_order_status: ~5 rows (approximately)
...
-- Dumping structure for table giaiphap247.shop_order_total
...
-- Dumping data for table giaiphap247.shop_order_total: ~15 rows (approximately)
...
-- Dumping structure for table giaiphap247.shop_payment_status
...
-- Dumping data for table giaiphap247.shop_payment_status: ~4 rows (approximately)
...
-- Dumping structure for table giaiphap247.shop_product
...
-- Dumping data for table giaiphap247.shop_product: ~45 rows (approximately)
...
INSERT INTO `shop_product` (`id`, `name`, `sku`, `keyword`, `description`, `image`, `content`, `brand_id`, `category_id`, `category_other`, `price`, `cost`, `stock`, `sold`, `type`, `option`, `sort`, `status`, `view`, `date_lastview`, `date_available`, `created_at`, `updated_at`) VALUES
	(3, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'MEGA2560', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 1, 17, NULL, 220000, 150000, 0, -5, 0, NULL, 0, 1, 0, NULL, NULL, '2018-01-15 14:57:31', '2018-08-24 06:24:08'),
	(4, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'LEDFAN1', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 3, 6, NULL, 190000, 100000, 17, -1, 1, NULL, 0, 1, 1, '2018-08-27 11:37:16', NULL, '2018-01-16 13:03:54', '2018-08-27 11:37:16'),
	(5, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'CLOCKFAN1', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 2, 13, NULL, 420000, 320000, 11, 1, 1, NULL, 0, 1, 2, '2018-09-03 17:09:50', NULL, '2018-01-16 13:04:41', '2018-09-03 17:09:50'),
	(6, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'CLOCKFAN2', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 1, 13, NULL, 380000, 250000, 99, 78, 2, NULL, 0, 1, 0, NULL, NULL, '2018-02-02 14:52:50', '2018-08-23 09:20:43'),
	(7, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'CLOCKFAN3', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 1, 13, NULL, 320000, 250000, 51, 0, 1, NULL, 1, 1, 0, NULL, NULL, '2018-02-02 14:53:30', '2018-08-23 09:20:25'),
	(8, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'TMC2208', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 8, 11, NULL, 220000, 130000, 101, 1, 0, NULL, 1, 1, 0, NULL, NULL, '2018-02-02 14:53:30', '2018-08-23 09:20:03'),
	(9, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'FILAMENT', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 8, 15, NULL, 299000, 200000, 127, 6, 2, NULL, 1, 1, 0, NULL, NULL, '2018-02-02 14:53:30', '2018-08-23 09:19:35'),
	(10, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'A4988', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 1, 11, NULL, 39000, 20000, 107, 33, 0, NULL, 1, 1, 0, NULL, NULL, '2018-02-02 14:53:30', '2018-06-27 16:21:10'),
	(11, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'ANYCUBIC-P', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 7, 10, NULL, 4990000, 3500000, 1, 1048, 0, NULL, 0, 1, 0, NULL, NULL, '2018-01-15 14:57:31', '2018-08-23 09:19:15'),
	(12, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', '3DHLFD', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 8, 12, NULL, 7990000, 5200000, 10, 20, 2, NULL, 0, 1, 0, NULL, NULL, '2018-01-15 14:57:31', '2018-09-03 17:15:38'),
	(20, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'SS495A', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 8, 14, NULL, 15000, 7000, 1006, 1058, 1, NULL, 0, 1, 1, '2018-08-27 11:54:00', NULL, '2018-01-15 14:57:31', '2018-08-27 11:54:00'),
	(21, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', '3D-CARBON1.75', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 8, 15, NULL, 390000, 0, 10, 19, 1, NULL, 1, 1, 0, NULL, NULL, '2018-02-02 14:53:30', '2018-08-15 14:52:43'),
	(22, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', '3D-GOLD1.75', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 8, 15, NULL, 500000, 0, 10, 1, 1, NULL, 1, 1, 0, NULL, NULL, '2018-04-12 15:05:37', '2018-08-02 16:01:38'),
	(23, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'LCD12864-3D', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 8, 11, NULL, 220000, 0, 0, 0, 0, NULL, 0, 1, 0, NULL, NULL, '2018-08-11 13:33:37', '2018-08-11 13:34:13'),
	(24, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'LCD2004-3D', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 8, 11, NULL, 190000, 0, 0, 0, 0, NULL, 0, 1, 0, NULL, NULL, '2018-08-11 13:39:31', '2018-08-11 13:39:31'),
	(25, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'RAMPS1.5-3D', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 8, 11, NULL, 120000, 0, 0, 0, 0, NULL, 0, 1, 0, NULL, NULL, '2018-08-11 13:41:25', '2018-08-11 13:41:25'),
	(26, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'EFULL-3D', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 8, 11, NULL, 890000, 0, 0, 0, 0, NULL, 0, 1, 1, '2018-08-28 06:39:46', NULL, '2018-08-11 13:50:25', '2018-09-03 17:15:38'),
	(27, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'ANYCUBIC-I3M', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 1, 10, '', 7990000, 0, 5, 0, 0, NULL, 0, 1, 0, NULL, NULL, '2018-08-22 16:26:00', '2018-09-03 17:15:38'),
	(28, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', '3DNOZZLE', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 8, 11, NULL, 10000, 0, 500, 0, 0, NULL, 0, 1, 0, NULL, NULL, '2018-08-24 04:21:48', '2018-08-24 04:29:04'),
	(29, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', '3D-TEFLONLOCK', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 1, 11, '', 10000, 0, 500, 0, 0, NULL, 0, 1, 0, NULL, NULL, '2018-08-24 04:32:48', '2018-09-02 23:46:23'),
	(30, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', '3D-BELT-GT2', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 0, 11, '', 20000, 0, 0, 0, 0, NULL, 0, 1, 1, '2018-08-31 21:00:47', NULL, '2018-08-24 04:35:39', '2018-09-02 23:49:17'),
	(31, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', '3D-TEFLONLOCK-M10', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 0, 11, NULL, 10000, 0, 100, 0, 0, NULL, 0, 1, 0, NULL, NULL, '2018-08-24 04:39:03', '2018-08-24 04:39:03'),
	(32, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', '3D-HOTWIRE1240', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 0, 11, NULL, 20000, 0, -1, 1, 1, NULL, 0, 1, 1, '2018-09-03 17:18:37', NULL, '2018-08-24 04:40:54', '2018-09-03 17:18:37'),
	(33, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', '3D-TEFTLON-24', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 0, 11, NULL, 15000, 0, 100, 0, 0, NULL, 0, 1, 0, NULL, NULL, '2018-08-24 04:44:04', '2018-08-24 04:45:51'),
	(34, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', '3D-TEFTLON-W24', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 0, 11, NULL, 20000, 0, 100, 0, 1, NULL, 0, 1, 0, NULL, NULL, '2018-08-24 05:09:34', '2018-08-24 05:09:34'),
	(35, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', '3D-SENSOR-NTC 100K', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 0, 11, NULL, 15000, 0, 100, 0, 1, NULL, 0, 1, 3, '2018-08-31 22:14:35', NULL, '2018-08-24 05:13:58', '2018-09-03 17:15:38'),
	(36, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'nRLF24L01+2.4HZ', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 0, 16, NULL, 25000, 0, 0, 0, 0, NULL, 0, 1, 0, NULL, NULL, '2018-08-24 06:07:15', '2018-08-24 06:18:50'),
	(37, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'ARDUINO-NANO', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 0, 17, NULL, 100000, 0, 0, 0, 0, NULL, 0, 1, 1, '2018-08-31 21:59:45', NULL, '2018-08-24 06:25:48', '2018-09-03 17:15:38'),
	(38, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'LEDSTRIP-5050RGB', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 0, 19, NULL, 0, 0, 0, 0, 0, NULL, 0, 1, 12, '2018-08-27 16:44:08', NULL, '2018-08-24 06:33:31', '2018-08-27 16:44:08'),
	(39, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'LEDSTRIP-S', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 0, 19, NULL, 0, 0, 0, 0, 0, NULL, 0, 1, 1, '2018-08-27 15:28:14', NULL, '2018-08-24 08:46:21', '2018-08-27 15:28:14'),
	(40, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'P10-IR', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 0, 19, NULL, 0, 0, 0, 0, 0, NULL, 0, 1, 6, '2018-08-30 23:20:31', NULL, '2018-08-24 08:49:49', '2018-08-30 23:20:31'),
	(41, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'P10-IG', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 0, 19, NULL, 0, 0, 0, 0, 0, NULL, 0, 1, 9, '2018-09-03 17:02:01', NULL, '2018-08-24 08:51:11', '2018-09-03 17:15:38'),
	(42, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'P10-IB', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 0, 19, '', 0, 0, 0, 0, 0, NULL, 0, 1, 9, '2018-08-31 21:45:43', NULL, '2018-08-24 08:52:58', '2018-09-02 21:30:34'),
	(43, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'P10-IRGB', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 0, 19, NULL, 0, 0, 0, 0, 0, NULL, 0, 1, 2, '2018-08-27 17:23:48', NULL, '2018-08-24 08:54:45', '2018-08-27 17:23:48'),
	(44, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'P10-IRG', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 0, 19, NULL, 0, 0, 0, 0, 0, NULL, 0, 1, 18, '2018-08-27 17:19:52', NULL, '2018-08-24 08:56:02', '2018-08-27 17:19:52'),
	(45, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'LFF', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 0, 6, NULL, 0, 0, 0, 0, 0, NULL, 0, 1, 0, NULL, NULL, '2018-08-24 08:58:42', '2018-08-24 08:58:42'),
	(46, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'P2.5-I', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 0, 19, '', 0, 0, 0, 0, 0, NULL, 0, 1, 10, '2018-09-01 01:05:52', NULL, '2018-08-24 09:23:07', '2018-09-03 17:15:38'),
	(47, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'BX-5U0', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 0, 19, '', 0, 0, 0, 0, 0, NULL, 0, 1, 63, '2018-09-01 08:00:51', NULL, '2018-08-24 09:48:31', '2018-09-03 17:15:38'),
	(48, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'BX-5UT', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 0, 19, '2,17', 0, 0, 0, 0, 0, NULL, 0, 1, 137, '2018-08-31 22:25:58', NULL, '2018-08-24 09:52:15', '2018-09-03 17:15:38'),
	(49, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'BX-5UTbnv', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 2, 2, '2', 0, 0, 0, 0, 0, NULL, 0, 1, 0, NULL, '2018-09-19 00:00:00', '2018-09-03 08:05:59', '2018-09-03 08:05:59'),
	(50, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'AKMMNH11dfds', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 2, 2, '', 0, 0, 0, 0, 0, NULL, 0, 0, 0, NULL, NULL, '2018-09-03 08:12:26', '2018-09-03 08:12:26'),
	(51, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'AKMMNH11fđgdf', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 4, 16, '2', 0, 0, 0, 0, 0, NULL, 0, 0, 0, NULL, NULL, '2018-09-03 08:13:08', '2018-09-03 08:13:08'),
	(52, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'AKMMNH11bnbvn', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 3, 2, '2', 0, 0, 0, 0, 0, NULL, 0, 0, 0, NULL, NULL, '2018-09-03 08:15:09', '2018-09-03 08:15:09'),
	(53, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'AKMMNH11vbnbvnb', 'quatang,ledfan', '', 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 3, 2, '16', 0, 0, 0, 0, 0, NULL, 0, 0, 0, NULL, '2018-09-03 00:00:00', '2018-09-03 08:18:06', '2018-09-03 08:18:06'),
	(54, 'Clock FAN Hiển Thị Ảnh Nhiều Màu Sắc', 'BX-5UTdfgdf', 'quatang,ledfan', NULL, 'product/3dbe489b702605d92f29d9087417bf33.jpg', '<p><strong><span style="font-size:20px;">Quạt đồng hồ đèn led nhiều m&agrave;u sắc hiển thị h&igrave;nh ảnh.</span></strong></p>\r\n\r\n<p><strong><span style="font-size:20px;">Tính năng v&agrave; th&ocirc;ng số:</span></strong></p>\r\n\r\n<p><span style="font-size:16px;">*** Hi&ecirc;̉n thị thời gian, nhiệt độ.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Hiển thịhiệu ứng chữ, h&igrave;nh ảnh nhiều m&agrave;u sắc được upload từđiện thoại di động th&ocirc;ng qua app được c&agrave;i đặt (hỗ trợ cho cả IOS v&agrave; ANDROID). tải app bằng QRCODE.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Thích hợp đ&ecirc;̉ bàn làm vi&ecirc;̣c, bàn học hoặc nơi trưng bày. Quạt r&acirc;́t mát, kh&ocirc;ng ồn.</span></p>\r\n\r\n<p><span style="font-size:16px;">*** Ngu&ocirc;̀n c&acirc;́p 5v từ c&ocirc;̉ng usb (laptop, pc, sạc di đ&ocirc;̣ng).</span></p>', 3, 16, '', 0, 0, 0, 0, 0, NULL, 0, 0, 0, NULL, NULL, '2018-09-03 08:27:43', '2018-09-03 17:19:14');
/*!40000 ALTER TABLE `shop_product` ENABLE KEYS */;

-- Dumping structure for table giaiphap247.shop_product_like
...
-- Dumping data for table giaiphap247.shop_product_like: ~0 rows (approximately)
...
-- Dumping structure for table giaiphap247.shop_product_recent_view
...
-- Dumping data for table giaiphap247.shop_product_recent_view: ~8 rows (approximately)
...
-- Dumping structure for table giaiphap247.shop_product_type
...
-- Dumping data for table giaiphap247.shop_product_type: ~18 rows (approximately)
...
INSERT INTO `shop_product_type` (`id`, `opt_name`, `opt_sku`, `opt_price`, `opt_image`, `product_id`) VALUES
	(3, 'Sản phẩm xanh', 'BX-5UT-s', 454, NULL, 48),
	(4, '34324234', 'BX-5UT-T', 1111, 'product/20b71c74f7b79e9ee33e403d290717e7.jpg', 48),
	(8, 'Loai 1', 'abc123', 20000, 'product/eeda585da48992dde1dd5fee61d8ab54.jpg', 47),
	(9, 'loai 2', 'abc321', 300000, 'product/ca5bbe08b02be98af1b11f28192694bc.jpg', 47),
	(11, 'Sản phẩm xanh', 'BX-5U0-1fgfg', 234234, NULL, 47),
	(12, 'fdgdfg', 'fgdfgd', NULL, 'product/218b5ad1e5a1583262b0d63e6bb21cb1.jpg', 42),
	(13, 'bnmbnmbn', 'BX-5U0-1fgfgjghjhgj', NULL, 'product/c965b93117d526bb8e5d86e8fe65d100.jpg', 42),
	(14, 'Sản phẩm xanh', 'BX-5U0-1fgfggfhf', NULL, 'product/58b5266a81f1366e85664272eb76d07f.jpg', 48),
	(15, 'Sản phẩm xanh', 'fsdfsf', NULL, 'product/6121aa305c74ee0dbcc973d249fdf321.jpg', 46),
	...
	(19, 'Sản phẩm xanh', 'BX-5U0-1fgfgbnvbn', NULL, 'product/0fdcec12adc8d4142d66fc14de6da616.jpg', 49),
	(20, 'Mạch Điều Khiển LED Matrix BT5U0 (Loai 1)', 'BX-5U0-1fgfgsdff', NULL, 'product/382fe3ee4379bacd6d0690c21606f15d.jpg', 50),
	(21, 'Sản phẩm xanh', 'BX-5U0-1fgfgffdg', NULL, 'product/d25171ce77fa72baaebd36713c3fab12.jpg', 51),
	(22, 'bnvbnbvnbvn', 'bnbvnvbnvbnvbnvbn', NULL, 'product/ca24fa351c1d73a3c14b603255636ee0.jpg', 52),
	(23, 'Sản phẩm xanh', 'fsdfsfbnvbnb', NULL, 'product/886491a88401755883e7058002d92e19.jpg', 53),
	(24, 'dfgdfgdfg', 'dfgdfgdfgdfg', NULL, 'product/f139f754bfeb9e956cef0ae58f7378cc.jpg', 54);
/*!40000 ALTER TABLE `shop_product_type` ENABLE KEYS */;

-- Dumping structure for table giaiphap247.shop_shipping
...
-- Dumping data for table giaiphap247.shop_shipping: ~1 rows (approximately)
...
-- Dumping structure for table giaiphap247.shop_shipping_address
...
-- Dumping data for table giaiphap247.shop_shipping_address: ~1 rows (approximately)
...
-- Dumping structure for table giaiphap247.shop_shipping_status
...
-- Dumping data for table giaiphap247.shop_shipping_status: ~3 rows (approximately)
...
-- Dumping structure for table giaiphap247.shop_shoppingcart
...
-- Dumping data for table giaiphap247.shop_shoppingcart: ~0 rows (approximately)
...
-- Dumping structure for table giaiphap247.shop_special_price
...
-- Dumping data for table giaiphap247.shop_special_price: ~8 rows (approximately)
...
-- Dumping structure for table giaiphap247.users
...
-- Dumping data for table giaiphap247.users: ~4 rows (approximately)
DELETE FROM `users`;
