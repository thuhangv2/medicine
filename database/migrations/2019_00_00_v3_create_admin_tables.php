...
class CreateAdminTables extends Migration
{
    ...
    public function importData()
    {
        DB::table('admin_menu')->insert([
            ...
            ['id' => 33, 'parent_id' => 0, 'sort' => 101, 'title' => 'lang::banner.admin.title', 'icon' => 'fa-image', 'uri' => 'admin::banner', 'type' => 0],
            ['id' => 10, 'parent_id' => 0, 'sort' => 102, 'title' => 'lang::page.admin.title', 'icon' => 'fa-clone', 'uri' => 'admin::page', 'type' => 0],
            ['id' => 52, 'parent_id' => 0, 'sort' => 103, 'title' => 'lang::news.admin.title', 'icon' => 'fa-file-powerpoint-o', 'uri' => 'admin::news', 'type' => 0],
            ...
            ['id' => 25, 'parent_id' => 5, 'sort' => 0, 'title' => 'lang::config.admin.title', 'icon' => 'fa-cog', 'uri' => 'admin::config', 'type' => 0],
            ['id' => 26, 'parent_id' => 5, 'sort' => 0, 'title' => 'lang::store.admin.title', 'icon' => 'fa-cogs', 'uri' => 'admin::store', 'type' => 0],
            ...
            ['id' => 34, 'parent_id' => 5, 'sort' => 0, 'title' => 'lang::backup.admin.title', 'icon' => 'fa-save', 'uri' => 'admin::backup', 'type' => 0],
