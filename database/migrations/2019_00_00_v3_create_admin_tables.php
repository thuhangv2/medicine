...
class CreateAdminTables extends Migration
{
    ...
    public function importData()
    {
        DB::table('admin_menu')->insert([
            ...
            ['id' => 25, 'parent_id' => 5, 'sort' => 1, 'title' => 'lang::store_value.admin.title', 'icon' => 'fa-cog', 'uri' => 'admin::store_value', 'type' => 0],
            ['id' => 26, 'parent_id' => 5, 'sort' => 2, 'title' => 'lang::store_info.admin.title', 'icon' => 'fa-cog', 'uri' => 'admin::store_info', 'type' => 0],
        ...
        DB::table('admin_permission')->insert([
            ...
            ['id' => '4', 'name' => 'Setting manager', 'slug' => 'setting.full', 'http_uri' => 'ANY::sc_admin/store_info/*,ANY::sc_admin/store_value/*,ANY::sc_admin/env/*,ANY::sc_admin/email/*,ANY::sc_admin/email_template/*,ANY::sc_admin/language/*,ANY::sc_admin/currency/*,ANY::sc_admin/backup/*', 'created_at' => date('Y-m-d H:i:s')],
