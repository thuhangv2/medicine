...
class CreateAdminTables extends Migration
{
    ...
    public function importData()
    {
        DB::table('admin_menu')->insert([
            ...
            ['id' => 22, 'parent_id' => 4, 'sort' => 0, 'title' => 'lang::layout.admin.title', 'icon' => 'fa-newspaper-o', 'uri' => 'route::admin_layout.index', 'type' => 0],
            ['id' => 23, 'parent_id' => 4, 'sort' => 0, 'title' => 'lang::layout_url.admin.title', 'icon' => 'fa-chrome', 'uri' => 'route::admin_layout_url.index', 'type' => 0],
