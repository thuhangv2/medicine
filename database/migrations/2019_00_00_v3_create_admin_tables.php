...
class CreateAdminTables extends Migration
{
    ...
    public function importData()
    {
        DB::table('admin_menu')->insert([
            ...
            ['id' => 6, 'parent_id' => 0, 'sort' => 10, 'title' => 'lang::ADMIN SHOP', 'icon' => '', 'uri' => '', 'type' => 1],
            ...
            ['id' => 14, 'parent_id' => 1, 'sort' => 5, 'title' => 'lang::payment_status.admin.title', 'icon' => 'fa-recycle', 'uri' => 'route::admin_payment_status.index', 'type' => 0],
            ['id' => 15, 'parent_id' => 2, 'sort' => 0, 'title' => 'lang::category.admin.title', 'icon' => 'fa-folder-open-o', 'uri' => 'route::admin_category.index', 'type' => 0],
            ['id' => 16, 'parent_id' => 2, 'sort' => 0, 'title' => 'lang::product.admin.title', 'icon' => 'fa-file-photo-o', 'uri' => 'route::admin_product.index', 'type' => 0],
            ['id' => 17, 'parent_id' => 2, 'sort' => 0, 'title' => 'lang::vendor.admin.title', 'icon' => 'fa-user-secret', 'uri' => 'route::admin_vendor.index', 'type' => 0],
            ['id' => 18, 'parent_id' => 2, 'sort' => 0, 'title' => 'lang::brand.admin.title', 'icon' => 'fa-bank', 'uri' => 'route::admin_brand.index', 'type' => 0],
            ['id' => 19, 'parent_id' => 2, 'sort' => 0, 'title' => 'lang::attribute_group.admin.title', 'icon' => 'fa-bars', 'uri' => 'route::admin_attribute_group.index', 'type' => 0],
            ['id' => 20, 'parent_id' => 3, 'sort' => 0, 'title' => 'lang::customer.admin.title', 'icon' => 'fa-user', 'uri' => 'route::admin_customer.index', 'type' => 0],
            ['id' => 21, 'parent_id' => 3, 'sort' => 0, 'title' => 'lang::subscribe.admin.title', 'icon' => 'fa-user-circle-o', 'uri' => 'route::admin_subscribe.index', 'type' => 0],
            ['id' => 22, 'parent_id' => 4, 'sort' => 0, 'title' => 'lang::block_content.admin.title', 'icon' => 'fa-newspaper-o', 'uri' => 'route::admin_block_content.index', 'type' => 0],
            ['id' => 23, 'parent_id' => 4, 'sort' => 0, 'title' => 'lang::link.admin.title', 'icon' => 'fa-chrome', 'uri' => 'route::admin_link.index', 'type' => 0],
            ['id' => 24, 'parent_id' => 4, 'sort' => 0, 'title' => 'lang::template.admin.title', 'icon' => 'fa-columns', 'uri' => 'route::admin_template.index', 'type' => 0],
            ['id' => 25, 'parent_id' => 5, 'sort' => 0, 'title' => 'lang::config.admin.title', 'icon' => 'fa-cog', 'uri' => 'route::admin_config.index', 'type' => 0],
            ['id' => 26, 'parent_id' => 5, 'sort' => 0, 'title' => 'lang::store.admin.title', 'icon' => 'fa-cogs', 'uri' => 'route::admin_store.index', 'type' => 0],
            ['id' => 27, 'parent_id' => 5, 'sort' => 0, 'title' => 'lang::admin.menu_titles.email_setting', 'icon' => 'fa-envelope', 'uri' => '', 'type' => 0],
            ['id' => 28, 'parent_id' => 27, 'sort' => 0, 'title' => 'lang::email.admin.title', 'icon' => 'fa-cog', 'uri' => 'route::admin_email.index', 'type' => 0],
            ['id' => 29, 'parent_id' => 27, 'sort' => 0, 'title' => 'lang::email_template.admin.title', 'icon' => 'fa-bars', 'uri' => 'route::admin_email_template.index', 'type' => 0],
            ['id' => 30, 'parent_id' => 5, 'sort' => 0, 'title' => 'lang::admin.menu_titles.localisation', 'icon' => 'fa-shirtsinbulk', 'uri' => '', 'type' => 0],
            ['id' => 31, 'parent_id' => 30, 'sort' => 0, 'title' => 'lang::language.admin.title', 'icon' => 'fa-pagelines', 'uri' => 'route::admin_language.index', 'type' => 0],
            ['id' => 32, 'parent_id' => 30, 'sort' => 0, 'title' => 'lang::currency.admin.title', 'icon' => 'fa-dollar', 'uri' => 'route::admin_currency.index', 'type' => 0],
            ['id' => 34, 'parent_id' => 5, 'sort' => 0, 'title' => 'lang::backup.admin.title', 'icon' => 'fa-save', 'uri' => 'route::admin_backup.index', 'type' => 0],
            ...
            ['id' => 38, 'parent_id' => 0, 'sort' => 0, 'title' => 'lang::admin.menu_titles.admin', 'icon' => 'fa-sitemap', 'uri' => '', 'type' => 0],
            ['id' => 39, 'parent_id' => 35, 'sort' => 0, 'title' => 'lang::Extensions/language.Payment', 'icon' => 'fa-money', 'uri' => 'admin::extension/payment', 'type' => 0],
            ['id' => 40, 'parent_id' => 35, 'sort' => 0, 'title' => 'lang::Extensions/language.Shipping', 'icon' => 'fa-ambulance', 'uri' => 'admin::extension/shipping', 'type' => 0],
        ...
        DB::table('admin_permission')->insert([
            ...
            ['id' => '4', 'name' => 'Setting manager', 'slug' => 'setting.full', 'http_uri' => 'ANY::sc_admin/config/*,ANY::sc_admin/store/*,ANY::sc_admin/email/*,ANY::sc_admin/email_template/*,ANY::sc_admin/language/*,ANY::sc_admin/currency/*,ANY::sc_admin/backup/*', 'created_at' => date('Y-m-d H:i:s')],
