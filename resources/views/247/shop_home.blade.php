                        ...
                        <div class="info-inner">
                          ...
                          <div class="item-content">
                            ...
                            <div class="pro-action">
                              <button onClick="addToCart({{ $product_hot->id }})" type="button" class="add-to-cart"><span> Add to Cart</span> </button>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="item-info">
                        <div class="info-inner">
                          ...
                          <div class="item-content">
                            ...
                            <div class="pro-action">
                              <button onClick="addToCart({{ $product->id }})" type="button" class="add-to-cart"><span> Add to Cart</span> </button>
                            </div>
                          </div>
                        </div>
                      </div>
