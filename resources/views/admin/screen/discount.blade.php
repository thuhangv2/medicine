                    ...
                    <div class="box-body">
                        <div class="fields-group">
                            ...
                            <div class="form-group   {{ $errors->has('code') ? ' has-error' : '' }}">
                                <label for="code" class="col-sm-2  control-label">{{ trans('Extensions\Total\Discount.code') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        @else
                                            <span class="help-block">
                                                <i class="fa fa-info-circle"></i>  {{ trans('Extensions\Total\Discount.admin.code_helper') }}
                                            </span>
                                        @endif
                                </div>
                            </div>
                            ...
                            <div class="form-group   {{ $errors->has('reward') ? ' has-error' : '' }}">
                                <label for="reward" class="col-sm-2  control-label">{{ trans('Extensions\Total\Discount.reward') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                            ...
                            <div class="form-group   {{ $errors->has('type') ? ' has-error' : '' }}">
                                <label for="type" class="col-sm-2  control-label">{{ trans('Extensions\Total\Discount.type') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                            ...
                            <div class="form-group   {{ $errors->has('data') ? ' has-error' : '' }}">
                                <label for="data" class="col-sm-2  control-label">{{ trans('Extensions\Total\Discount.data') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                            ...
                            <div class="form-group   {{ $errors->has('limit') ? ' has-error' : '' }}">
                                <label for="limit" class="col-sm-2  control-label">{{ trans('Extensions\Total\Discount.limit') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                            ...
                            <div class="form-group   {{ $errors->has('login') ? ' has-error' : '' }}">
                                <label for="login" class="col-sm-2  control-label">{{ trans('Extensions\Total\Discount.login') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                            ...
                            <div class="form-group   {{ $errors->has('expires_at') ? ' has-error' : '' }}">
                                <label for="expires_at" class="col-sm-2  control-label">{{ trans('Extensions\Total\Discount.expires_at') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                            ...
                            <div class="form-group  ">
                                <label for="status" class="col-sm-2  control-label">{{ trans('Extensions\Total\Discount.status') }}</label>
                                <div class="col-sm-8">
