...
return [
    ...
    'permission'        => [
        'process'        => 'Thiết lập quyền thư mục: storage,vendor,public/documments',
    ...
    'validate'          => [
        ...
        'admin_url_required'     => 'Đường dẫn tới Admin bbawts buộc',
    ],
    'installing_button' => 'Đang cài đặt S-Cart',
    'database_host'     => 'Địa chỉ máy chủ dữ liệu',
    'database_port'     => 'Port dữ liệu',
    'database_name'     => 'Tên dữ liệu',
    'database_user'     => 'Người dùng kết nối dữ liệu',
    'database_password' => 'Mật khẩu kết nối dữ liệu',
    'admin_url'         => 'Đường dẫn url Admin',
